...
namespace StarterAssets
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [Tooltip("Dash speed of the character")]
        ...
        private void HandleDash()
        {
            ...
            if (_input.dash && !_isDashing && _dashCooldownTimer <= 0)
            {
                _isDashing = true;
                _dashTimeLeft = DashDuration;
                _dashCooldownTimer = DashCooldown;

                _dashDirection = new Vector3(_input.move.x, 0.0f, _input.move.y).normalized;
