...
public class SequenceController : MonoBehaviour {
    ...
    public Transform _parentObject; //rings get spawned under this
    ...
    private void LoadParameters()
    {
        ...
        for (int i = 0; i < SongLoader.instance.activeSong.rings.Length; i++)
        {
            ...
            GameObject newRing = Instantiate(ringPrefab, this.gameObject.transform.position, this.gameObject.transform.rotation);
    ...
    {        
        Debug.Log("Populating Rings " + ringParents.Length);
        //Populate Rings
        for (int i = 0; i < ringParents.Length; i++)
        {            
