...
public class RingParent : MonoBehaviour {
    ...
    public void PopulateRing(float ringDistance)
    {
        ...
        for (int i = 0; i <beats.Count; i++)
        {
            ...
            GameObject newCircle = Instantiate(circlePrefab, this.gameObject.transform.position, this.gameObject.transform.rotation);            
            ...
            circleScript.LocateCircle(ringDistance,true);
    ...
    public void ActivateRing(int ringSpot)
    {
        ...
        ringActive = true;
        /*animator.SetTrigger("Activate");*/ //comment out so don't start the animator.
